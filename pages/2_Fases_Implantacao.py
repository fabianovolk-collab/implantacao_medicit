...
responsavel = col3.text_input("Responsável Clinica", value=dados["Responsavel_Etapa"])
...
motivo = st.text_input("Motivo (Bloqueio/Atraso)", value=dados.get("Motivo", ""))
...
if st.button("💾 Salvar"):
    ...
    if bloqueado == "Sim" and motivo.strip() == "":
        st.warning("Informe o motivo do bloqueio/atraso")
        st.stop()
